...
(function(f) {
    "object"===typeof module&&module.exports?(f["default"]=f, module.exports=f):"function"===typeof define&&define.amd?define("highcharts/modules/stock-tools", ["highcharts", "highcharts/modules/stock"], function(p) {
        f(p);
        f.Highcharts=p;
        return f
    }
    ...
    function p(h, f, p, n) {
        h.hasOwnProperty(f)||(h[f]=n.apply(null, p))
    }
    f=f?f._modules: {}
    ;
    p(f, "modules/stock-tools-bindings.js", [f["parts/Globals.js"], f["parts/Utilities.js"]], function(h, f) {
        var p=f.defined, n=f.isNumber, l=h.fireEvent, t=h.pick;
        f=h.extend;
        var k=h.merge, q=h.correctFloat, d=h.NavigationBindings.prototype.utils;
        d.addFlagFromForm=function(a) {
            return function(b) {
                var c=this, g=c.chart, e=g.stockTools, m=d.getFieldType;
                b=d.attractToPoint(b, g);
                var w= {
                    type:"flags", onSeries:b.series.id, shape:a, data:[ {
                        x: b.x, y: b.y
                    }
                    ], point: {
                        events: {
                            click:function() {
                                ...
                                l(c, "showPopup", {
                                    point:a, formType:"annotation-toolbar", options: {
                                        langKey: "flags", type: "flags", title: [b.title, m(b.title)], name: [b.name, m(b.name)]
                                    }
                                    , onSubmit:function(b) {
                ...
                ;
                e&&e.guiEnabled||g.addSeries(w);
                l(c, "showPopup", {
                    formType:"flag", options: {
                        langKey: "flags", type: "flags", title: ["A", m("A")], name: ["Flag A", m("Flag A")]
                    }
                    , onSubmit:function(a) {
                        c.fieldsToOptions(a.fields, w.data[0]);
                        g.addSeries(w)
                    }
                }
                )
        ...
        ;
        d.manageIndicators=function(a) {
            var b=this.chart, c= {
                linkedTo: a.linkedTo, type: a.type
            }
            , g=["ad", "cmf", "mfi", "vbp", "vwap"], e="ad atr cci cmf macd mfi roc rsi vwap ao aroon aroonoscillator trix apo dpo ppo natr williamsr stochastic linearRegression linearRegressionSlope linearRegressionIntercept linearRegressionAngle".split(" ");
            if("edit"===a.actionType)this.fieldsToOptions(a.fields, c), (a=b.get(a.seriesId))&&a.update(c, !1);
                ...
                if(a=b.get(a.seriesId)) {
                    ...
                    a.remove(!1);
                    0<=e.indexOf(a.type)&&(m.remove(!1), this.resizeYAxes())
                }
            }
            else c.id=h.uniqueKey(), this.fieldsToOptions(a.fields, c), 0<=e.indexOf(a.type)?(m=b.addAxis( {
                id:h.uniqueKey(), offset:0, opposite:!0, title: {
                    text: ""
                }
                , tickPixelInterval:40, showLastLabel:!1, labels: {
                    align: "left", y: -2
                }
            }
            , !1, !1), c.yAxis=m.options.id, this.resizeYAxes()):c.yAxis=b.get(a.linkedTo).options.yAxis, 0<=g.indexOf(a.type)&&(c.params.volumeSeriesID=b.series.filter(function(a) {
        ...
        ;
        d.attractToPoint=function(a, b) {
            a=b.pointer.getCoordinates(a);
            var c=a.xAxis[0].value;
            a=a.yAxis[0].value;
            var g=Number.MAX_VALUE, e;
            b.series.forEach(function(a) {
                a.points.forEach(function(a) {
                    a&&g>Math.abs(a.x-c)&&(g=Math.abs(a.x-c), e=a)
                }
                )
            }
            );
            return {
                x: e.x, y: e.y, below: a<e.y, series: e.series, xAxis: e.series.xAxis.index||0, yAxis: e.series.yAxis.index||0
            }
        }
        ;
        d.isNotNavigatorYAxis=function(a) {
            return"highcharts-navigator-yaxis"!==a.userOptions.className
        }
        ;
        d.updateNthPoint=function(a) {
            return function(b, c) {
                var g=c.options.typeOptions;
                b=this.chart.pointer.getCoordinates(b);
                var e=b.xAxis[0].value, m=b.yAxis[0].value;
                g.points.forEach(function(b, c) {
                    c>=a&&(b.x=e, b.y=m)
                }
                );
                c.update( {
        ...
        ;
        f(h.NavigationBindings.prototype, {
            getYAxisPositions:function(a, b, c) {
                function g(a) {
                    return p(a)&&!n(a)&&a.match("%")
                }
                var e=0;
                a=a.map(function(a) {
                    var m=g(a.options.height)?parseFloat(a.options.height)/100: a.height/b;
                    a=g(a.options.top)?parseFloat(a.options.top)/100: q(a.top-a.chart.plotTop)/b;
                    n(m)||(m=c/100);
                    e=q(e+m);
                    return {
                        height: 100*m, top: 100*a
                    }
                }
                );
                a.allAxesHeight=e;
            ...
            , resizeYAxes:function(a) {
                a=a||20;
                var b=this.chart, c=b.yAxis.filter(this.utils.isNotNavigatorYAxis), g=c.length;
                b=this.getYAxisPositions(c, b.plotHeight, a);
                var e=this.getYAxisResizers(c), m=b.allAxesHeight, d=a;
                1<m?(6>g?(b[0].height=q(b[0].height-d), b=this.recalculateYAxisPositions(b, d)):(a=100/g, b=this.recalculateYAxisPositions(b, a/ (g-1), !0, -1)), b[g-1]= {
                    top: q(100-a), height: a
                }
                ):(d=100*q(1-m), 5>g?(b[0].height=q(b[0].height+d), b=this.recalculateYAxisPositions(b, d)):b=this.recalculateYAxisPositions(b, d/g, !0, 1));
                b.forEach(function(a, b) {
                    c[b].update( {
                        height: a.height+"%", top: a.top+"%", resize: e[b]
                    }
                    , !1)
                }
                )
            }
            , recalculateYAxisPositions:function(a, b, c, g) {
                a.forEach(function(e, m) {
                    m=a[m-1];
                    e.top=m?q(m.height+m.top): 0;
                    c&&(e.height=q(e.height+g*b))
                }
                );
                return a
            }
        ...
        f= {
            ...
            , ray: {
                className:"highcharts-ray", start:function(a) {
                    ...
                    var b=this.chart.options.navigation;
                    a=k( {
                        langKey:"ray", type:"crookedLine", typeOptions: {
                            type:"ray", points:[ {
                                x: a.xAxis[0].value, y: a.yAxis[0].value
                            }
                            , {
            ...
            , arrowRay: {
                className:"highcharts-arrow-ray", start:function(a) {
                    ...
                    var b=this.chart.options.navigation;
                    a=k( {
                        langKey:"arrowRay", type:"infinityLine", typeOptions: {
                            type:"ray", line: {
                                markerEnd: "arrow"
                            }
                            , points:[ {
            ...
            , horizontalLine: {
                className:"highcharts-horizontal-line", start:function(a) {
                    ...
                    var b=this.chart.options.navigation;
                    a=k( {
                        langKey:"horizontalLine", type:"infinityLine", draggable:"y", typeOptions: {
                            type:"horizontalLine", points:[ {
                                x: a.xAxis[0].value, y: a.yAxis[0].value
                            }
                            ]
                        }
            ...
            , verticalLine: {
                className:"highcharts-vertical-line", start:function(a) {
                    ...
                    var b=this.chart.options.navigation;
                    a=k( {
                        langKey:"verticalLine", type:"infinityLine", draggable:"x", typeOptions: {
                            type:"verticalLine", points:[ {
                                x: a.xAxis[0].value, y: a.yAxis[0].value
                            }
                            ]
                        }
            ...
            , crooked3: {
                ...
                , steps:[d.updateNthPoint(1), d.updateNthPoint(2)]
            }
            , crooked5: {
                className:"highcharts-crooked5", start:function(a) {
                    ...
                    var b=this.chart.options.navigation;
                    a=k( {
                        langKey:"crookedLine", type:"crookedLine", typeOptions: {
                            points:[ {
                                x: a.xAxis[0].value, y: a.yAxis[0].value
                            }
                            , {
                ...
                , steps:[d.updateNthPoint(1), d.updateNthPoint(2), d.updateNthPoint(3), d.updateNthPoint(4)]
            }
            , elliott3: {
                ...
                , steps:[d.updateNthPoint(1), d.updateNthPoint(2), d.updateNthPoint(3)]
            }
            , elliott5: {
                ...
                , steps:[d.updateNthPoint(1), d.updateNthPoint(2), d.updateNthPoint(3), d.updateNthPoint(4), d.updateNthPoint(5)]
            }
            , measureX: {
                className:"highcharts-measure-x", start:function(a) {
                    ...
                    a=k( {
                        langKey:"measure", type:"measure", typeOptions: {
                            selectType:"x", point: {
                                x: a.xAxis[0].value, y: a.yAxis[0].value, xAxis: 0, yAxis: 0
                            }
                            , crosshairX: {
                                strokeWidth: 1, stroke: "#000000"
                            }
                            , crosshairY: {
                                enabled: !1, strokeWidth: 0, stroke: "#000000"
                            }
                            , background: {
                                width: 0, height: 0, strokeWidth: 0, stroke: "#ffffff"
                            }
                        }
                        , labelOptions: {
                            style: {
                ...
                className:"highcharts-measure-xy", start:function(a) {
                    ...
                    a=k( {
                        langKey:"measure", type:"measure", typeOptions: {
                            ...
                            , background: {
                                width: 0, height: 0, strokeWidth: 10
                            }
                            , crosshairX: {
                                strokeWidth: 1, stroke: "#000000"
                            }
            ...
            , fibonacci: {
                className:"highcharts-fibonacci", start:function(a) {
                    ...
                    var b=this.chart.options.navigation;
                    a=k( {
                        langKey:"fibonacci", type:"fibonacci", typeOptions: {
                            points:[ {
                                x: a.xAxis[0].value, y: a.yAxis[0].value
                            }
                            , {
                ...
                , steps:[d.updateNthPoint(1), d.updateHeight]
            }
            , parallelChannel: {
                className:"highcharts-parallel-channel", start:function(a) {
                    ...
                    var b=this.chart.options.navigation;
                    a=k( {
                        langKey:"parallelChannel", type:"tunnel", typeOptions: {
                            points:[ {
                                x: a.xAxis[0].value, y: a.yAxis[0].value
                            }
                            , {
                ...
                className:"highcharts-pitchfork", start:function(a) {
                    ...
                    a=k( {
                        langKey:"pitchfork", type:"pitchfork", typeOptions: {
                            points:[ {
                                x:a.xAxis[0].value, y:a.yAxis[0].value, controlPoint: {
                                    style: {
                                        fill: "red"
                                    }
                                }
            ...
            , verticalCounter: {
                className:"highcharts-vertical-counter", start:function(a) {
                    a=d.attractToPoint(a, this.chart);
                    var b=this.chart.options.navigation, c=p(this.verticalCounter)?this.verticalCounter: 0;
                    a=k( {
                        langKey:"verticalCounter", type:"verticalLine", typeOptions: {
                            point: {
                                x: a.x, y: a.y, xAxis: a.xAxis, yAxis: a.yAxis
                            }
                            , label: {
                                offset: a.below?40: -40, text: c.toString()
                            }
                        }
                        , labelOptions: {
                            style: {
            ...
            , verticalLabel: {
                className:"highcharts-vertical-label", start:function(a) {
                    ...
                    var b=this.chart.options.navigation;
                    a=k( {
                        langKey:"verticalLabel", type:"verticalLine", typeOptions: {
                            point: {
                                x: a.x, y: a.y, xAxis: a.xAxis, yAxis: a.yAxis
                            }
                            , label: {
            ...
            , verticalArrow: {
                className:"highcharts-vertical-arrow", start:function(a) {
                    ...
                    var b=this.chart.options.navigation;
                    a=k( {
                        langKey:"verticalArrow", type:"verticalLine", typeOptions: {
                            point: {
                                x: a.x, y: a.y, xAxis: a.xAxis, yAxis: a.yAxis
                            }
                            , label: {
                                offset: a.below?40: -40, format: " "
                            }
                            , connector: {
                                fill: "none", stroke: a.below?"red": "green"
                            }
                        }
                        , shapeOptions: {
                            stroke: "rgba(0, 0, 0, 0.75)", strokeWidth: 1
            ...
            , flagCirclepin: {
                className: "highcharts-flag-circlepin", start: d.addFlagFromForm("circlepin")
            }
            , flagDiamondpin: {
                className: "highcharts-flag-diamondpin", start: d.addFlagFromForm("flag")
            }
            , flagSquarepin: {
                className: "highcharts-flag-squarepin", start: d.addFlagFromForm("squarepin")
            }
            , flagSimplepin: {
                className: "highcharts-flag-simplepin", start: d.addFlagFromForm("nopin")
            }
            , zoomX: {
            ...
            , fullScreen: {
                className:"highcharts-full-screen", init:function(a) {
                    var b=this.chart;
                    b.fullScreen=new h.FullScreen(b.container);
                    l(this, "deselectButton", {
                        button: a
                    }
                    )
            ...
            , currentPriceIndicator: {
                className:"highcharts-current-price-indicator", init:function(a) {
                    var b=this.chart, c=b.series[0], g=c.options, e=g.lastVisiblePrice&&g.lastVisiblePrice.enabled;
                    g=g.lastPrice&&g.lastPrice.enabled;
                    b=b.stockTools;
                    var m=b.getIconsURL();
                    b&&b.guiEnabled&&(a.firstChild.style["background-image"]=g?'url("'+m+'current-price-show.svg")': 'url("'+m+'current-price-hide.svg")');
                    c.update( {
                        lastPrice: {
                            enabled: !g, color: "red"
                        }
            ...
            , toggleAnnotations: {
                className:"highcharts-toggle-annotations", init:function(a) {
                    var b=this.chart, c=b.stockTools, g=c.getIconsURL();
                    this.toggledAnnotations=!this.toggledAnnotations;
                    (b.annotations||[]).forEach(function(a) {
                        a.setVisibility(!this.toggledAnnotations)
                    }
                    , this);
                    c&&c.guiEnabled&& (a.firstChild.style["background-image"]=this.toggledAnnotations?'url("'+g+'annotations-hidden.svg")':'url("'+g+'annotations-visible.svg")');
                    l(this, "deselectButton", {
                        button: a
                    }
                    )
            ...
            saveChart: {
                ...
                init:function(a) {
                    ...
                    c.series.forEach(function(a) {
                        a instanceof h.seriesTypes.sma?e.push(a.userOptions): "flags"===a.type&&m.push(a.userOptions)
                    }
                    );
                    c.yAxis.forEach(function(a) {
                        b.utils.isNotNavigatorYAxis(a)&& d.push(a.options)
                    }
                    );
                    h.win.localStorage.setItem("highcharts-chart", JSON.stringify( {
                        annotations: g, indicators: e, flags: m, yAxes: d
                    }
                    ));
                    l(this, "deselectButton", {
                        button: a
    ...
    p(f,
    "modules/stock-tools-gui.js",
    [f["parts/Globals.js"],
    f["parts/Utilities.js"]],
    function(h, f) {
        var p=f.isArray,
        n=h.addEvent,
        l=h.createElement,
            ...
            , stockTools: {
                gui: {
                    enabled:!0, className:"highcharts-bindings-wrapper", toolbarClassName:"stocktools-toolbar", buttons:"indicators separator simpleShapes lines crookedLines measure advanced toggleAnnotations separator verticalLabels flags separator zoomChange fullScreen typeChange separator currentPriceIndicator saveChart".split(" "), definitions: {
                        ...
                        , simpleShapes: {
                            items:["label", "circle", "rectangle"], circle: {
                                symbol: "circle.svg"
                            }
                            , rectangle: {
                        ...
                        , flags: {
                            items:["flagCirclepin", "flagDiamondpin", "flagSquarepin", "flagSimplepin"], flagSimplepin: {
                        ...
                        , lines: {
                            items:"segment arrowSegment ray arrowRay line arrowLine horizontalLine verticalLine".split(" "), segment: {
                                symbol: "segment.svg"
                            }
                            , arrowSegment: {
                        ...
                        , crookedLines: {
                            items:["elliott3", "elliott5", "crooked3", "crooked5"], crooked3: {
                        ...
                        , verticalLabels: {
                            items:["verticalCounter", "verticalLabel", "verticalArrow"], verticalCounter: {
                        ...
                        , advanced: {
                            items:["fibonacci", "pitchfork", "parallelChannel"], pitchfork: {
                        ...
                        , measure: {
                            items:["measureXY", "measureX", "measureY"], measureX: {
                        ...
                        , zoomChange: {
                            items:["zoomX", "zoomY", "zoomXY"], zoomX: {
                                symbol: "zoom-x.svg"
                            }
                            , zoomY: {
                                symbol: "zoom-y.svg"
                        ...
                        , typeChange: {
                            items:["typeOHLC", "typeLine", "typeCandlestick"], typeOHLC: {
        ...
        n(h.Chart, "afterGetContainer", function() {
            this.setStockTools()
        }
        );
        n(h.Chart, "getMargins", function() {
            var a=this.stockTools&&this.stockTools.listWrapper;
            (a=a&&(a.startWidth+h.getStyle(a, "padding-left")+h.getStyle(a, "padding-right")||a.offsetWidth))&&a<this.plotWidth&&(this.plotLeft+=a)
        }
        );
        n(h.Chart, "destroy", function() {
            this.stockTools&&this.stockTools.destroy()
        }
        );
        n(h.Chart, "redraw", function() {
            this.stockTools&&this.stockTools.guiEnabled&&this.stockTools.redraw()
        }
        );
        h.Toolbar=function(a, b, e) {
            this.chart=e;
            this.options=a;
            this.lang=b;
            this.iconsURL=this.getIconsURL();
            this.guiEnabled=a.enabled;
            this.visible=t(a.visible,
            !0);
            this.placed=t(a.placed,
            !1);
            this.eventsToUnbind=[];
            this.guiEnabled&&(this.createHTML(),
            this.init(),
        ...
        h.extend(h.Chart.prototype,
        {
            setStockTools:function(a) {
                var b=this.options,
                c=b.lang;
                a=d(b.stockTools&&b.stockTools.gui, a&&a.gui);
                this.stockTools=new h.Toolbar(a, c.stockTools&&c.stockTools.gui, this);
        ...
        h.Toolbar.prototype= {
            init:function() {
                ...
                f.forEach(function(c) {
                    r=a.addButton(d, l, c, b);
                    q&&"fullScreen"===c&&(r.buttonWrapper.className+=" highcharts-disabled-btn");
                    ["click",
                    "touchstart"].forEach(function(b) {
                        n(r.buttonWrapper, b, function() {
                            a.eraseActiveButtons(k, r.buttonWrapper)
                        }
                        )
                    }
                    );
                    p(l[c].items)&&h.call(a, r, l[c])
                }
                )
            }
            ,
            addSubmenu:function(b,
            g) {
                var c=this,
                d=b.submenuArrow,
                f=b.buttonWrapper,
                ...
                null,
                f);
                this.addSubmenuItems(f,
                g);
                ["click",
                "touchstart"].forEach(function(b) {
                    n(d, b, function(b) {
                        b.stopPropagation();
                        c.eraseActiveButtons(t, f);
                        0<=f.className.indexOf("highcharts-current")?(v.style.width=v.startWidth+"px", f.classList.remove("highcharts-current"), u.style.display="none"):(u.style.display="block", r=u.offsetHeight-f.offsetHeight-3, u.offsetHeight+f.offsetTop>p.offsetHeight&&f.offsetTop>r||(r=0), a(u, {
                            top: -r+"px", left: k+3+"px"
                        }
                        ), f.className+=" highcharts-current", v.startWidth=p.offsetWidth, v.style.width=v.startWidth+h.getStyle(v, "padding-left")+u.offsetWidth+3+"px")
                    }
                    )
                }
                )
            ...
            b) {
                ...
                b.items.forEach(function(e) {
                    f=c.addButton(g, b, e, d);
                    ["click",
                    "touchstart"].forEach(function(b) {
                        n(f.mainButton, b, function() {
                            c.switchSymbol(this, a, !0);
                            h.style.width=h.startWidth+"px";
                ...
                var l=g.querySelectorAll("li > .highcharts-menu-item-btn")[0];
                c.switchSymbol(l,
                !1)
            }
            ,
            eraseActiveButtons:function(a,
            b,
            e) {
                [].forEach.call(a,
                function(a) {
                    a!==b&&(a.classList.remove("highcharts-current"), a.classList.remove("highcharts-active"), e=a.querySelectorAll(".highcharts-submenu-wrapper"), 0<e.length&&(e[0].style.display="none"))
                }
                )
            }
            ,
            ...
            d) {
                ...
                e=l("li",
                {
                    className: t(h.Toolbar.prototype.classMapping[e], "")+" "+g, title: d[e]||e
                }
                ,
                null,
                a);
                ...
                if(c&&c.length) {
                    ...
                    null,
                    e);
                    f.style["background-image"]="url("+this.iconsURL+ "arrow-bottom.svg)"
                }
                else a.style["background-image"]="url("+this.iconsURL+b.symbol+")";
                return {
                    buttonWrapper: e, mainButton: a, submenuArrow: f
                }
            }
            ,
            addNavigation:function() {
                var a=this.wrapper;
                this.arrowWrapper=l("div",
                {
                ...
                a.insertBefore(this.arrowWrapper,
                a.childNodes[0]);
                this.scrollButtons()
            }
            ,
            scrollButtons:function() {
                ...
                f=.1*e.offsetHeight;
                ["click",
                "touchstart"].forEach(function(c) {
                    n(b.arrowUp, c, function() {
                        0<a&&(a-=f, d.style["margin-top"]=-a+"px")
                    }
                    );
                    n(b.arrowDown, c, function() {
                        e.offsetHeight+a<=d.offsetHeight+f&&(a+=f, d.style["margin-top"]=-a+"px")
                    }
                    )
                }
                )
            ...
            showHideToolbar:function() {
                ...
                null,
                b);
                k.style["background-image"]="url("+this.iconsURL+"arrow-right.svg)";
                f?(b.style.height="100%",
                k.style.top=h.getStyle(e, "padding-top")+"px",
                k.style.left=b.offsetWidth+h.getStyle(e, "padding-left")+"px"):(d&&(d.style.display="none"),
                k.style.left="0px",
                this.visible=f=!1,
                e.classList.add("highcharts-hide"),
                k.classList.toggle("highcharts-arrow-right"),
            ...
            getIconsURL:function() {
                return this.chart.options.navigation.iconsURL||this.options.iconsURL||"https://code.highcharts.com/7.2.0/gfx/stock-icons/"
            }
            ,
            classMapping: {
    ...
    p(f,
    "masters/modules/stock-tools.src.js",
    [],
    function() {}
    )
}
